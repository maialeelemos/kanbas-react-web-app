        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    <li>Spread peanut butter on one side of one piece of toast.</li>
                    <li>Spread jam on one side of a different piece of toast.</li>
                    <li>Place toast with jam on toast with peanut butter so that jam and peanut butter sides touching.</li>
                </ol>
            ...
            <a id="wd-github" href="https://github.com/maialeelemos/kanbas-react-web-app">Github</a>
            <br/>
